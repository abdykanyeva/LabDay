...
public class TrainBookingApp {
    public static void main(String[] args) {
        ...
        System.out.println("Choose your travel time? (Train: 1, Bus: 2, Flight: 3");
        ...
        if(!(from.equalsIgnoreCase("Berlin") && to.equalsIgnoreCase("Amsterdam"))){
            System.out.println("For now we can only serve Berlin-Amsterdam transportation. PLease change your destinations ");
            return; // sto JVM
        }
